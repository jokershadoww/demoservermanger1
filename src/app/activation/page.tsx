    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-zinc-900 to-black p-4">
      <div className="w-full max-w-md bg-zinc-900/50 border border-white/10 rounded-2xl p-8 backdrop-blur-xl shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">تفعيل الموقع</h1>
          <p className="text-zinc-400 text-sm">أدخل كود التفعيل لمتابعة تسجيل الدخول</p>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-300">كود التفعيل</label>
            <input
              name="code"
              type="text"
              required
